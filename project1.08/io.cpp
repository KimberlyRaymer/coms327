...
void io_pokemon()
{
  ...
  while (found)
  {
    ...
    {
      mvprintw(0, 0, "Press esc to leave window \n A wild shiny %s appeared! \n Level: %d \n Health: %d \n Attack: %d \n Defense: %d \n Speed: %d \n Special Attack: %d \n Special Defense: %d \n", pokemon.name.c_str(), pokemon.level, pokemon.hp, pokemon.attack, pokemon.defense, pokemon.speed, pokemon.s_Attack, pokemon.s_Defense);
    }
    else
    {
      mvprintw(0, 0, "Press esc to leave window \n A wild %s appeared! \n Level: %d \n Health: %d \n Attack: %d \n Defense: %d \n Speed: %d \n Special Attack: %d \n Special Defense: %d \n", pokemon.name.c_str(), pokemon.level, pokemon.hp, pokemon.attack, pokemon.defense, pokemon.speed, pokemon.s_Attack, pokemon.s_Defense);
